...
$pageTitle = 'Income Management - Rosmon SMS';
...
<div class="main-container">
    <div class="top-header">
        <div class="greeting">Module / <span style="color:var(--primary)">Income Management</span></div>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h2 class="crud-title">Manage Income Management</h2>
        </div>
