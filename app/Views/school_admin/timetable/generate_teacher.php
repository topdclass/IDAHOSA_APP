...
$pageTitle = 'Generate For Teacher - Rosmon SMS';
...
<div class="main-container">
    <div class="top-header">
        <div class="greeting">Module / <span style="color:var(--primary)">Generate For Teacher</span></div>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h2 class="crud-title">Manage Generate For Teacher</h2>
        </div>
