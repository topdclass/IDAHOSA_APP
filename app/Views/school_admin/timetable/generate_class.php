...
$pageTitle = 'Generate For Class - Rosmon SMS';
...
<div class="main-container">
    <div class="top-header">
        <div class="greeting">Module / <span style="color:var(--primary)">Generate For Class</span></div>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h2 class="crud-title">Manage Generate For Class</h2>
        </div>
