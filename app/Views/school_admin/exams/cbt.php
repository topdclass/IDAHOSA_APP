...
$pageTitle = 'Computer-Based Test (CBT) - Rosmon SMS';
...
<div class="main-container">
    <div class="top-header">
        <div class="greeting">Module / <span style="color:var(--primary)">Computer-Based Test (CBT)</span></div>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h2 class="crud-title">Manage Computer-Based Test (CBT)</h2>
        </div>
