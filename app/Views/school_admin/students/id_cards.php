...
$pageTitle = 'Student ID Cards - Rosmon SMS';
...
<div class="main-container">
    <div class="top-header">
        <div class="greeting">Module / <span style="color:var(--primary)">Student ID Cards</span></div>
    ...
    <div class="crud-card">
        <div class="crud-header">
            <h2 class="crud-title">Manage Student ID Cards</h2>
        </div>
